...
namespace PdfSharp3dAnnot
{
    public sealed class Pdf3dAnnotation : PdfAnnotation
    {
        ...
        public PdfDocument replaceImageWith3DAnnotation(String u3dFilePath, int pageNumber)
        {
            bool success = false;
            if (this.document != null)
            {
                this._u3dPath = u3dFilePath;
                PdfPage page = this.document.Pages[pageNumber];
        ...
        public PdfDocument create3DPdf(String u3dFilePath)
        {
            ...
            {
                return this.replaceImageWith3DAnnotation(u3dFilePath,0);
            }
            return null;
        }
        ...
        private bool add3DDDictionaryObject()
        {
            ...
            try
            {
               ...
               // PdfArray c2wMatrix = new PdfArray();

               // c2wMatrix.Elements.Add();

                //va.Elements.SetObject(Key.C2W, c2wMatrix);
